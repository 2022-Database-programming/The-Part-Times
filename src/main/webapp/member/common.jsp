<!-- 로그인 후, 표시되는 main 화면
    main.jsp record-work-time.jsp, salary-calculation.jsp, community-board.jsp 를 포함
-->
        ...
        <div id="main_container">
            ...
            <div id="content_container">
                ...
                <div class="contents disable">
                    <div data-include-path="../content/record-work-time.html"></div>
                </div>
                <div class="contents disable">
                    <div data-include-path="../content/salary-calculation.jsp"></div>
                </div>
                <div class="contents disable">
                    <div data-include-path="community-board.html"></div>
                </div>
