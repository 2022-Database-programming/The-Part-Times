...
//		int rs = 0;
//		String sql = "INSERT INTO " + TABLE_NAME + " (id, post_id, reply_id, is_anonymous, content, likes, layer, created_at, updated_at, member_id)" + " VALUES (comment_seq.nextval, ?, NULL, ?, ?, ?, ?, DEFAULT, DEFAULT, ?)";
//
//		Object[] param = new Object[] { replyDto.getPostId(),
//				replyDto.getIsAnonymous(),
//				replyDto.getContent(), replyDto.getLikes(), replyDto.getLayer(), replyDto.getMemberId()};
